      ...
      <div className="container max-w-screen-2xl py-12 px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="flex flex-col gap-4 text-right">
            <Link href="/">
              <a className="hover:opacity-90 transition-opacity w-fit mr-0 md:mr-auto lg:mr-0 ml-auto md:ml-0">
        ...
        <div className="mt-12 pt-8 border-t border-border/40 text-center text-sm text-muted-foreground">
          <p>© {new Date().getFullYear()} Learn Platform. Powered by AI. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
